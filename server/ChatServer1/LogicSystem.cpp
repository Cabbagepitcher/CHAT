...
void LogicSystem::AddFriendApply(std::shared_ptr<CSession> session, const short& msg_id, const string& msg_data)
{
	...
	Defer defer([this, &rtvalue, session]() {
		std::string return_str = rtvalue.toStyledString();
		std::cout << "ID_ADD_FRIEND_RSP is" << return_str << std::endl;
	...
	std::cout << "uid is" << uid << "  touid is" << touid << "  applyname is" << applyname << std::endl;
	std::cout << "已发送ChatGrpcClient::GetInstance()->NotifyAddFriend(to_ip_value,add_req);" << std::endl;
	//发送通知
