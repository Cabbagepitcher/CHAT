...
//      ui->pass_visible->SetState("unvisible","unvisible_hover","visible_hover","visible",
//                                 "visible_hover","visible_hover");

//      ui->confirm_visible->SetState("unvisible","unvisible_hover","visible_hover","visible",
//                                   "visible_hover","visible_hover");
...
//         qDebug()<<"user uuind is"<< jsonObj["uid"].toString();
//         qDebug()<< "email is " << email ;
//         ChangeTipPage();
//     });
...
// void RegisterDialog::on_sure_btn_clicked()//注册确认按钮
// {
//     if(ui->user_edit->text() == ""){
